        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>R$<?php echo format_real($order["vltotal"]); ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>R$<?php echo format_real($cart["vlsubtotal"]); ?></td>
                </tr>
                <tr>
                    <th>Frete:</th>
                    <td>R$<?php echo format_real($cart["vlfreight"]); ?></td>
                </tr>
                <tr>
                    <th>Total:</th>
                    <td>R$<?php echo format_real($cart["vltotal"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
